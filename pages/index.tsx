        ...
        {!isConnected ? (
          ...
          <div className="max-w-2xl mx-auto">
            <div className="card-elevated text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Connectez votre portefeuille</h2>
              <p className="text-slate-300 mb-8 max-w-md mx-auto">
                Vous devez connecter votre portefeuille Web3 pour utiliser le calculateur.
                Cliquez sur le bouton "Connect Wallet" en haut a droite pour commencer.
              </p>
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5">
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div>
                    <p className="text-blue-300 font-medium mb-1">Conseil</p>
                    <p className="text-blue-200/70 text-sm">
                      Utilisez MetaMask, WalletConnect ou une autre extension Web3 compatible
                    </p>
                  </div>
                </div>
              </div>
